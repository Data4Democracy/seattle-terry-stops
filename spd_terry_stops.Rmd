...
- Running logistic regression models to determine what factors within the Terry Stop data are predictive of arrest 
...
1.  What is the probability the the percentage of persons of color subject to Terry Stops in Seattle is due to chance, assuming the Census data represents the true mean?
